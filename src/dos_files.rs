...
pub const MSDOS_COMMANDS: &[&str] = &[
    "APPEND.EXE", "ATTRIB.EXE", "CHKDSK.EXE", "CHOICE.COM", "DEBUG.EXE",
    "DEFRAG.EXE", "DELTREE.EXE", "DISKCOMP.COM", "DISKCOPY.COM", "DOSKEY.COM",
    "DOSSHELL.EXE", "EDIT.COM", "EDLIN.EXE", "EMM386.EXE", "EXPAND.EXE",
    "FASTHELP.EXE", "FASTOPEN.EXE", "FC.EXE", "FDISK.EXE", "FIND.EXE",
    "FORMAT.COM", "GRAFTABL.COM", "GRAPHICS.COM", "HELP.COM", "INTERLNK.EXE",
    "INTERSVR.EXE", "KEYB.COM", "LABEL.EXE", "LOADFIX.COM", "MEM.EXE",
    "MEMMAKER.EXE", "MODE.COM", "MORE.COM", "MOVE.EXE", "MSAV.EXE",
    "MSBACKUP.EXE", "MSD.EXE", "NLSFUNC.EXE", "POWER.EXE", "PRINT.EXE",
    "QBASIC.EXE", "REPLACE.EXE", "RESTORE.EXE", "SCANDISK.EXE", "SETVER.EXE",
    "SHARE.EXE", "SIZER.EXE", "SMARTDRV.EXE", "SORT.EXE", "SUBST.EXE",
    "SYS.COM", "TREE.COM", "UNDELETE.EXE", "UNFORMAT.COM", "VSAFE.COM",
    "XCOPY.EXE",
];

// Common drivers
pub const COMMON_DRIVERS: &[&str] = &[
    "HIMEM.SYS", "EMM386.EXE", "RAMDRIVE.SYS", "ANSI.SYS", "COUNTRY.SYS",
    "DISPLAY.SYS", "DRIVER.SYS", "KEYBOARD.SYS", "PRINTER.SYS",
    "MOUSE.COM", "MOUSE.SYS", "SETVER.EXE", "SMARTDRV.EXE",
];

// Configuration files and examples
pub const CONFIG_FILES: &[&str] = &[
    "AUTOEXEC.UMB", "AUTOEXEC.DOS", "CONFIG.UMB", "CONFIG.DOS",
    "NETWORKS.TXT", "README.TXT", "APPS.HLP", "MSBACKUP.INI",
    "MSBACKUP.CFG", "MSAV.INI", "DEFRAG.INI", "QBASIC.INI",
];
...
pub const WP51_FILES: &[&str] = &[
    "WP\\WP.EXE", "WP\\WP.FIL", "WP\\STANDARD.PRS", "WP\\MACROS.WPM",
    "WP\\STYLES.STY", "WP\\GRAPHCNV.EXE", "WP\\WPINFO.TXT",
];

// Lotus 1-2-3
pub const LOTUS123_FILES: &[&str] = &[
    "123\\123.EXE", "123\\123.CNF", "123\\WYSIWYG.CNF", "123\\DEFAULT.FNT",
    "123\\SAMPLES\\SALES.WK1", "123\\SAMPLES\\FINANCE.WK1",
];
...
pub const NORTON_UTILS_FILES: &[&str] = &[
    "NORTON\\NU.EXE", "NORTON\\SPEEDISK.EXE", "NORTON\\DISKDOC.EXE",
    "NORTON\\UNERASE.EXE", "NORTON\\SYSINFO.EXE",
];
...
pub const DOOM_FILES: &[&str] = &[
    "DOOM\\DOOM.EXE", "DOOM\\DOOM.WAD", "DOOM\\SETUP.EXE", "DOOM\\DEHACKED.EXE",
    "DOOM\\DM.WAD", "DOOM\\DOOM2.WAD", "DOOM\\TNT.WAD", "DOOM\\PLUTONIA.WAD",
];

// Duke Nukem 3D
pub const DUKE3D_FILES: &[&str] = &[
    "DUKE3D\\DUKE3D.EXE", "DUKE3D\\DUKE.RTS", "DUKE3D\\SETUP.EXE", "DUKE3D\\USER.CON",
    "DUKE3D\\GAME.CON", "DUKE3D\\DUKEMATCH.CON",
];

// Wolfenstein 3D
pub const WOLF3D_FILES: &[&str] = &[
    "WOLF3D\\WOLF3D.EXE", "WOLF3D\\VGAHEAD.V3D", "WOLF3D\\VGAGRAPH.V3D",
    "WOLF3D\\VSWAP.V3D", "WOLF3D\\AUDIO.W3D", "WOLF3D\\MAPHEAD.W3D",
];

// Civilization
pub const CIV_FILES: &[&str] = &[
    "CIV\\CIV.EXE", "CIV\\MAP.GIF", "CIV\\CIV.SVE", "CIV\\DIPLOMAT.TXT",
    "CIV\\INTRO.EXE",
];

// The Secret of Monkey Island
pub const MONKEY_ISLAND_FILES: &[&str] = &[
    "MONKEY\\MONKEY.EXE", "MONKEY\\000.LFL", "MONKEY\\901.LFL", "MONKEY\\DISK01.LEC",
];

// --- Windows 3.1 / 3.11 (often on top of DOS) ---
pub const WINDOWS_31_FILES: &[&str] = &[
    "WINDOWS\\WIN.COM", "WINDOWS\\SYSTEM.INI", "WINDOWS\\WIN.INI",
    "WINDOWS\\PROGMAN.EXE", "WINDOWS\\PROGMAN.INI",
    ...
    "WINDOWS\\SYSTEM\\SHELL.DLL", "WINDOWS\\SYSTEM\\WINFILE.EXE",
    "WINDOWS\\SOL.EXE", "WINDOWS\\WINMINE.EXE", "WINDOWS\\CLOCK.EXE",
    "WINDOWS\\WRITE.EXE", "WINDOWS\\NOTEPAD.EXE", "WINDOWS\\REGEDIT.EXE",
    "WINDOWS\\CONTROL.EXE", "WINDOWS\\CALC.EXE", "WINDOWS\\CARDFILE.EXE",
];
